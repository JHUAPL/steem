...
; MacBook.
;plot_events, eevt, vals, max_spec_per_step = 3, max_windows = 32, mon_index = 0, ysize = 1028 * 7 / 8

; Home monitor.
plot_events, eevt, vals, max_spec_per_step = 3, max_windows = 32, mon_index = 1, ysize = 1418 * 7 / 8
