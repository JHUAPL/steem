...
function PlotEventsHandler::MouseDown, window, x, y, button, keymods, clicks
  ...
  if clicks eq 1 then begin
    ...
    ; Return 0 here to disable the default handler from also getting called.
    ; The default handler would pop up an annoying properties window.
    return, 0
  endif
...
pro PlotEventsHandler::add_plot, the_plot
